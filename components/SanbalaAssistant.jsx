...
const sections = [
  ...
  },
  {
    ...
    icon: faChartLine,
    description: "ملخصات وروابط سريعة للتقارير والتحليلات",
    questions: [
      "اعرض ملخص النظام",
      "اعرض ملخص الأصول",
      "افتح التقارير",
  ...
  const [chat, setChat] = useState([
    {
      from: "assistant",
      answer:
        "أهلًا، أنا مساعد السنبلة. اختار قسم من الأعلى، وبعدها اختار سؤال جاهز عشان أديك إجابة دقيقة.",
      items: [],
      suggestions: [],
    },
  ]);
    ...
    setChat([
      {
        from: "assistant",
        answer:
          "اختار القسم اللي عايز تسأل عنه من الأعلى، وأنا هعرضلك الأسئلة المتاحة.",
        items: [],
        suggestions: [],
      },
    ]);
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/40 backdrop-blur-sm">
          ...
          >
            ...
            <div className="border-b border-slate-100 bg-white p-4">
              ...
              {!selectedSection ? (
                <div className="grid max-h-[42vh] gap-2 overflow-y-auto pl-1">
                ...
                <div className="flex max-h-[26vh] flex-wrap gap-2 overflow-y-auto pl-1">
