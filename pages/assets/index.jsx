          ...
          page.innerHTML = `
            <div
              style="
                ...
                border-radius: 14px;
                ${
                  entry.groupNumber === 34
                    ? "background: #15803d; color: #ffffff;"
                    : entry.unmatched
                    ? "background: #fffbeb; border: 1px solid #f59e0b;"
                    : "background: #eaf8ef; border: 1px solid #ccebd7;"
                }
              "
            >
              <div
              ...
              >
                <div
                  ...
                  "
                >
                  ${entry.unmatched ? "—" : entry.groupNumber}
                </div>
                ...
                <div>
                  ...
                  >
                    ${
                      entry.unmatched
                        ? "نوع جديد غير موجود في ترتيب الشيت القديم"
                        : `البند رقم ${entry.groupNumber} — ${escapeHtml(
                            entry.groupTitle
                          )}`
                    }
                  </div>
