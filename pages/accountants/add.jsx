...
const addAccountantToCache = (accountant) =>
  setCachedCollection("cache:accountants", [
    accountant,
    ...getCachedCollection("cache:accountants"),
  ]);
...
export default function AddAccountant() {
  ...
  if (loadingRole || !canManage) {
    return (
      <ProtectedRoute>
        <Layout title="إضافة محاسب">
          <AppLoader
            variant="compact"
            title="جاري التحقق من الصلاحيات..."
            subtitle="يتم التأكد من صلاحية إضافة محاسب"
          />
        </Layout>
      </ProtectedRoute>
    );
