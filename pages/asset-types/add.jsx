...
export default function AddAssetType(){const router=useRouter(); const [form,setForm]=useState({name:"",notes:""}); const [loading,setLoading]=useState(false); const submit=async(e)=>{e.preventDefault(); if(!form.name.trim())return alert("اسم نوع المعدة مطلوب"); setLoading(true);if (!name.trim()) {
