            ...
            <tbody>
              {items.map((w) => (
                <tr key={w.id} className="border-t">
                  <td className="table-td font-bold">{w.name}</td>
                  <td className="table-td">{w.phone || "-"}</td>
                  <td className="table-td">{w.nationality || "-"}</td>

                  <td className="table-td">
                    <div className="flex gap-2">
                      <Link className="btn-secondary !p-2" href={`/workers/${w.id}`}>
