...
const getAssetPlaceType = (asset) =>
  getValue(asset.placeType, asset.currentPlace?.type, asset.place?.type);
...
const isAssetInFarm = (asset) =>
  ...
  getAssetPlaceType(asset) === "farm" ||
  Boolean(asset.farmId);

const isAssetInKubra = (asset) =>
  asset.placeType === "kubra" ||
  getAssetPlaceType(asset) === "kubra" ||
  Boolean(asset.kubraId);
